...
The Swedish Taxonomy Database, [Dyntaxa](https://artfakta.se/metadata/dyntaxa), constitutes one of the 100 resources used to build the GBIF Backbone Taxonomy. Read more about the GBIF Backbone and see the full list of checklists behind the GBIF Backbone Taxonomy at the [dataset page](https://doi.org/10.15468/39omei).