...
GBIF Sweden is part of the Europe and Central Asia (ECA) region. To read more about the ECA nodes activities and annual meetings, visit our [GitHub community page](https://github.com/GBIF-Europe). Contact information to other active nodes and organizations within the region can be found at the [regional ECA network page](https://www.gbif.org/the-gbif-network?group=EUROPE) in the GBIF portal.